// Leaflet plugin to add an SVG layer to D3
// ========================================
// I tried using browserify-shim before, but it seemed like a lot of work
// and complexity for things I'm not expecting to update. Instead, I've just
// vendored this file, wrapped it in an immediately invoked function expression
// and placed the function inside module.exports so that it can be required
// by browserify.
//
// Source
// ======
